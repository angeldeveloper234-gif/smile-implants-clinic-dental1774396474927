            ...
            <div className="container mx-auto px-4 max-w-3xl">
                <div className="bg-primary/5 border border-primary/20 rounded-2xl p-8 backdrop-blur-sm">
                    ...
                    <p className="text-gray-400 mb-8 font-light">
                        Registra nuevos casos de éxito y transformaciones para {config.branding.name}.
                    </p>

                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div>
                            <label className="block text-sm font-medium text-gray-300 mb-2">
                                Título del Caso / Tratamiento
                            </label>
                            <input
                                type="text"
                                required
                                ...
                                placeholder="Ej: Diseño de Sonrisa - Paciente MR"
                            />
                        </div>
                        ...
                        <div className="pt-4">
                            <button
                                type="submit"
                                className="w-full bg-primary text-white font-semibold py-4 rounded-full hover:bg-white hover:text-black transition-all transform hover:scale-[1.02] active:scale-[0.98] shadow-[0_0_20px_rgba(14,165,233,0.3)]"
                            >
                                Registrar Caso
                            </button>
                        </div>
